...
- The nodes /labelLU/ and /layerLU/ are redundant and carry no information (except the fixed string "Target"), so they could be omitted.
  We have included them to be faithful to the fntbox ontology (sec [[*fntbox ontology]]).
