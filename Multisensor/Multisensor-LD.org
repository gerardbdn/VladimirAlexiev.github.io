...
| owl:sameAs      | http://de.dbpedia.org/resource/Wuppertal_Institut_fГјr_Klima,_Umwelt,_Energie | identity link to DE resource |
...
http://de.dbpedia.org/resource/Wuppertal_Institut_fГјr_Klima,_Umwelt,_Energie
...
| owl:sameAs                    | dbpedia-de:Wuppertal Institut fГјr Klima, Umwelt, Energie            | same as itself? Very useful ;-) | 
* FreeBase
...
- Ozacar, T.: IRIS: A Protégé Plug-in to Extract and Serialize Product Attribute Name-Value Pairs.
...
Here I describe large-scale Linguistic resources; Linguistic Ontologies will come later.\\
