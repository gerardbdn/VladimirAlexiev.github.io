...
* Table of Contents                                            :TOC:noexport:
 ...
 - [[#validation][Validation]]
   - [[#context-extraction-service][Context Extraction Service]]
     - [[#todo-crawler-to-decode-html-entities][TODO Crawler to decode HTML entities]]
     - [[#done-keywords-vs-category][DONE Keywords vs Category]]
     - [[#todo-ingest-timestamp][TODO Ingest Timestamp]]
     - [[#todo-simmo-quality][TODO SIMMO Quality]]
     - [[#cancel-missing-authors][CANCEL Missing Authors]]
     - [[#cancel-genre-type][CANCEL Genre (Type)]]
     - [[#done-wrong-prefix-for-text-characteristics][DONE Wrong prefix for Text Characteristics]]
   - [[#entity-linking-service][Entity Linking Service]]
     - [[#todo-underscores-to-spaces][TODO Underscores to Spaces]]
   - [[#entity-alignment-service][Entity Alignment Service]]
     - [[#done-also-remove-taidentconf-taidentprov][DONE Also remove taIdentConf, taIdentProv]]
     - [[#done-leave-dependency-links][DONE Leave Dependency Links]]
     - [[#todo-use-prefixes-in-alignmentlog][TODO Use Prefixes in alignment.log]]
   - [[#summarization-service][Summarization Service]]
     - [[#todo-refresh-prefixes][TODO Refresh Prefixes]]
     - [[#todo-nifanchorof][TODO nif:anchorOf]]
     - [[#todo-why-nif-anntaidentconf-is-0][TODO Why nif-ann:taIdentConf is 0?]]
     - [[#todo-msgenericconcept-vs-msspecificconcept][TODO ms:GenericConcept vs ms:SpecificConcept]]
     - [[#done-optimize-summarization-queries][DONE Optimize Summarization Queries]]
   - [[#content-alignment][Content Alignment]]
     - [[#todo-one-annotation-per-pair][TODO One Annotation Per Pair]]
     - [[#todo-use-msscore-not-fiseconfidence-for-cap][TODO Use ms:score not fise:confidence for CAP]]
     - [[#todo-add-to-ontology][TODO Add to Ontology]]
     - [[#cap-query][CAP Query]]
     - [[#todo-other-cap-queries][TODO Other CAP Queries]]
