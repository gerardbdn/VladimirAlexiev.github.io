...
#+REVEAL_TITLE_SLIDE_TEMPLATE: 2D <a href="index.html">interactive presentation</a>
#+REVEAL_TITLE_SLIDE_TEMPLATE: (<a href="Semantic Technologies for Cultural Heritage.pdf">printable version</a>).
