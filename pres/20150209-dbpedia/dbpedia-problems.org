...
#+REVEAL_TITLE_SLIDE_TEMPLATE: <h2>%t</h2><h3>or Crowdsourcing the Wisdom of Fools</h3><h4>%a</h4><h5>%e</h5>
...
- Hard to know when to use it: [[Mapping Server Deficiencies]], Field Sampling
